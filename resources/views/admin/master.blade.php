    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="top-nav clearfix">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{ asset('/') }}admin/images/1.jpg">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();"><i class="fa fa-key"></i> Log Out</a>
...
{{--                    </li>--}}
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{ route('add-doctors') }}">Add-Doctors</a></li>
                            <li><a href="{{ route('manage-doctors') }}">Manage-Doctors</a></li>
                        </ul>
                    </li>
