    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <form action="{{ route('update-patients') }}" method="POST" class="form-horizontal" role="form">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="department" value="{{ $searchDoctor->department }}" class="form-control">
                                <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="yourName" value="{{ $searchDoctor->yourName }}" class="form-control" id="nameName" placeholder="Your Name">
                            <input type="hidden" name="id" value="{{ $searchDoctor->id }}" class="form-control" id="nameName" placeholder="Your Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="number" name="mobile" value="{{ $searchDoctor->mobile }}" class="form-control" id="mobile" placeholder="Mobile">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="email" name="email" value="{{ $searchDoctor->email }}" class="form-control" id="email1" placeholder="Email">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="gender" value="{{ $searchDoctor->gender}}" class="form-control">
                                <option></option>
                                <option>Male</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="symptoms" value="{{ $searchDoctor->symptoms }}"  class="form-control" id="symptoms" placeholder="Symptoms">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="date" name="date"  value="{{ $searchDoctor->date }}"  class="form-control" id="date" placeholder="Date">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="time" value="{{ $searchDoctor->time }}" class="form-control">
                                <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="payment" value="{{ $searchDoctor->payment }}" class="form-control">
                                <option></option>
