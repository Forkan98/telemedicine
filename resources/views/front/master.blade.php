...
Smartphone Compatible web template, free web designs for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{ asset('/') }}front/css/flexslider.css" type="text/css" media="screen" Department="" />
...
<div class="Department_girds_agileits">
    <div class="agile_team_grid">
        ...
        <div class="col-md-3 w3ls_banner_bottom_grid">
            <img src="{{ asset('/') }}front/images/g1.jpg" alt=" " class="img-responsive" />
            <div class="overlay">
                <h4>Department 1</h4>
        ...
        <div class="col-md-3 w3ls_banner_bottom_grid">
            <img src="{{ asset('/') }}front/images/g2.jpg" alt=" " class="img-responsive" />
            <div class="overlay">
                <h4>Department 2</h4>
                <ul class="social_agileinfo">
                    <li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="col-md-3 w3ls_banner_bottom_grid hvr-shutter-in-horizontal">
            <img src="{{ asset('/') }}front/images/g3.jpg" alt=" " class="img-responsive" />
            <div class="overlay">
                <h4>Department 3</h4>
                <ul class="social_agileinfo">
                    <li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="col-md-3 w3ls_banner_bottom_grid">
            <img src="{{ asset('/') }}front/images/g4.jpg" alt=" " class="img-responsive" />
            <div class="overlay">
                <h4>Department 4</h4>
                <ul class="social_agileinfo">
                    <li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="ziehharmonika">
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image">
                            <img src="{{ asset('/') }}front/images/g5.jpg" alt="Medicinal">
                        </div>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image two">
                            <img src="{{ asset('/') }}front/images/g6.jpg" alt="Medicinal">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image">
                            <img src="{{ asset('/') }}front/images/g7.jpg" alt="Medicinal">
                        </div>
                        <div class="col-md-6 col-sm-6 tab-info">
                            <h4>We are having department to us</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting... </p>
                ...
                <div>
                    <div class="w3_agile_recipe-grid">
                        ...
                        <div class="col-md-6 col-sm-6 tab-image two">
                            <img src="{{ asset('/') }}front/images/g2.jpg" alt="Medicinal">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
